result=[]
up="[7,7,7,7,7,7,7,5,5,5,5]"
down="[5,5,5,5,5,5,5,7,7,7,7]"
...
def shineA(time):
    return(f"{time}\t{up} {alloff} {alllightup} {alloff} {alllightup}\n")
def shineB(time):
...
def shineD(time):
    return(f"{time}\t{alloff} {alllightup} {alloff} {alllightup} {alloff}\n")
def shineE(time):
    return(f"{time}\t{allred} {allwhite} {allred} {allwhite} {allred}\n")
def shineF(time):
    return(f"{time}\t{allwhite} {allred} {allwhite} {allred} {allwhite}\n")
def shineG(time):
    return(f"{time}\t{allred} {allred} {allred} {allred} {allred}\n")
def shineH(time):
    return(f"{time}\t{alloff} {alloff} {alloff} {alloff} {alloff}\n")
def shineI(time):
    return(f"{time}\t{allblue} {allblue} {allblue} {allblue} {allblue}\n")
def shineW(time):
    return(f"{time}\t{allwhite} {allwhite} {allwhite} {allwhite} {allwhite}\n")
